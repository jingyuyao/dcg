...
//        new CreateCard("Diplomacy", 0).addOnEnterEffects(new AdjustPower(1)),
        ...
        //            .addOnEnterEffects(
        //                new CreateUnit("Fearless Nomad", 2).addOnEnterEffects(new
        // SetBerserk(true))),
        ...
        //            .addOnEnterEffects(
        //                new CreateUnit("Oni Ronin", 1), new AdjustStrength(1), new
        // AdjustStrength(1)),
        ...
        //            .addOnEnterEffects(new CreateUnit("Grenadin Drone", 2), new
        // CreateUnit("Grenadin", 1)),
        //        new CreateCard("Withering Witch", 0)
        //            .addOnEnterEffects(
        //                new CreateUnit("Withering Witch", 2).addOnEnterEffects(new
        // AdjustDefense(3))),
